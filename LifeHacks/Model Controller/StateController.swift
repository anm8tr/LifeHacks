...
class StateController {
    ...
    var user = User(name: "John Doe", aboutMe: "I'm the user of this app", profileImage: "Avatar", reputation: 100  )
    ...
    var question = Question(
        ...
        score: 24,
        owner: User(name: "michalepri", aboutMe: "Moderator Pro Tempore on Lifehacks.SE", profileImage: "Avatar", reputation: 5276)
    )
}
